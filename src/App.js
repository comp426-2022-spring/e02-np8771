...
// 1. Create other variables for assignments, exams, and engagement here
    ...
    let currentE01 = document.querySelector('#a06').value
    let currentE02 = document.querySelector('#a07').value
...
// 2. This line is where you add the points all together. Add your other variable references here. Make sure that they match what is above and what is below in the HTML form
    let sum = parseInt(currentA00) + parseInt(currentA01) + parseInt(currentA02) + parseInt(currentA03) + parseInt(currentA04) + parseInt(currentA05) + parseInt(currentE01) + parseInt(currentE02) + parseInt(currentA99);
    setCurrentSum(sum);
  }
  ...
  return (
    <div className="App">
      ...
      <form>
            ...
            <input type="text" id="a06" placeholder="e01" /><br/><br/>
            <input type="text" id="a07" placeholder="e02" /><br/><br/>
